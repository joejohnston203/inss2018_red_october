...
def Huber_setup(file_U235='/home/joe/research/ric_rates_spectra/neutrino_spectrum/U235-anti-neutrino-flux-250keV.dat',
                file_Pu239="/home/joe/research/ric_rates_spectra/neutrino_spectrum/Pu239-anti-neutrino-flux-250keV.dat",
                file_Pu241="/home/joe/research/ric_rates_spectra/neutrino_spectrum/Pu241-anti-neutrino-flux-250keV.dat"):
...
def dRdEnu_Pu239_corrected(Enu):
    # check global setup
    global huber_setup_complete
...
def dRdEnu_Pu241_corrected(Enu):
    # check global setup
    global huber_setup_complete
...
def dRdEnu_U238_corrected(Enu):
    # Huber does not have data for U238
    return dRdEnu_U238(Enu)


def dRdEnu_fuel_frac_corrected(Enu):
    '''
    Reactor anti neutrino spectrum from Pu239 (see arXiv:1101.2663v3), per
    fission
    ...
    spectrum = U235frac*dRdEnu_U235_corrected(Enu) +\
                U238frac*dRdEnu_U238_corrected(Enu) +\
                Pu239frac*dRdEnu_Pu239_corrected(Enu) +\
                Pu241frac*dRdEnu_Pu241_corrected(Enu)
